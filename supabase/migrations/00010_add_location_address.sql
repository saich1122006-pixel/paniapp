-- ============================================================================
-- Migration 00010: Add location_address to jobs
-- ============================================================================

ALTER TABLE public.jobs ADD COLUMN IF NOT EXISTS location_address TEXT;
COMMENT ON COLUMN public.jobs.location_address IS 'Human-readable address for the job location.';

-- Update get_filtered_jobs_v2 to include location_address
